...
export const getPrecios = async () => {
  let url = `http://localhost:3004/precios`;
  const options = {
    method: "GET",
    headers: {
...
export const getPrecioId = async (id) => {
  let url = `http://localhost:3004/precios/${id}`;
  const options = {
    method: "GET",
    headers: {
      "content-type": "application/x-www-form-urlencoded",
...
// };
// Crear nuevo empresa
export const addPrecio = async (datos) => {
  // console.log(datos);
...
export const modifPrecio = async (datos, id) => {
  // console.log(datos);
  const token = JSON.parse(localStorage.getItem("token")) || "";
  let url = `http://localhost:3004/precios/${id}`;
  const options = {
...
export const delPrecio = async (id) => {
  const token = JSON.parse(localStorage.getItem("token")) || "";
  let url = `http://localhost:3004/precios/${id}`;
  const options = {
    method: "DELETE",
