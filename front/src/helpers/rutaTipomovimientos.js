...
export const getTipomovimientos = async () => {
  let url = `http://localhost:3004/tipomovimientos`;
  const options = {
    method: "GET",
    headers: {
...
export const getTipomovimientoId = async (id) => {
  let url = `http://localhost:3004/Tipomovimientos/${id}`;
  const options = {
    method: "GET",
    headers: {
      "content-type": "application/x-www-form-urlencoded",
...
export const addStock = async (datos) => {
  ...
  let url = "http://localhost:3004/stocks";
  const options = {
    method: "POST",
    headers: {
      "content-type": "application/x-www-form-urlencoded",
...
export const modifStock = async (datos, id) => {
  // console.log(datos);
  // const token = JSON.parse(localStorage.getItem("token")) || "";
  let url = `http://localhost:3004/stocks/${id}`;
  const options = {
    method: "PUT",
    headers: {
      "content-type": "application/x-www-form-urlencoded",
