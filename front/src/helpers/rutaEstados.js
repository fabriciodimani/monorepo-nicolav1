...
export const getEstados = async () => {
  let url = `http://localhost:3004/estados`;
  const options = {
    method: "GET",
    headers: {
...
export const getEstadoId = async (id) => {
  let url = `http://localhost:3004/estados/${id}`;
  const options = {
    method: "GET",
    headers: {
      "content-type": "application/x-www-form-urlencoded",
...
// };
// Crear nuevo empresa
export const addEstado = async (datos) => {
  // console.log(datos);
...
export const modifEstado = async (datos, id) => {
  // console.log(datos);
  const token = JSON.parse(localStorage.getItem("token")) || "";
  let url = `http://localhost:3004/estados/${id}`;
  const options = {
...
export const delEstado = async (id) => {
  const token = JSON.parse(localStorage.getItem("token")) || "";
  let url = `http://localhost:3004/estados/${id}`;
  const options = {
    method: "DELETE",
