...
import AddRubro from "../components/AddRubro";
import TableRubros from "../components/TableRubros";
         ...
         */}
            <div className="row">
              {state.role === "ADMIN_ROLE" ? (
                <>
                  <div className="">
                    <h3 className="mt-3 mb-2">ABM DE RUBROS</h3>
                    <hr />
                  </div>
                  <div className="mt-3 mb-3">
                    <AddRubro setShow={setShow} show={show} />
                  </div>
                  <div className="mt-3 mb-3">
                    {show === false && <TableRubros />}
                  </div>
                </>
              ) : (
                <div className="col">
